        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold text-white leading-tight mb-6">
              Precision Laptop Care Backed by <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">30+ Years</span> of Expertise.
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 border-t border-white/10 pt-8">
               <div className="flex items-center gap-3">
                 ...
                 <span className="text-sm font-medium text-textMain">30+ Years Exp.</span>
               </div>
               <div className="flex items-center gap-3">
